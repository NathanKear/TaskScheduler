...
public class CriticalPathCostEstimatorTests {

    ICostEstimator _costEstimator;

    @Before
    public void setupTests() {
        _costEstimator = new CriticalPathCostEstimator();
    }
    ...
    @Test
    public void getCostEstimate_ReturnsFinalCost_WhenOneNodeLeftToAdd() {
        // Arrange
